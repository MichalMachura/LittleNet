...
if __name__ == '__main__':
    ...
    trainer = training.load_trainer(net, optimizer, state_dict, device, strict=False)
    trainer.to(device)
    trainer.additional_state['info'].append("Epoche "+str(trainer.current_epoch)+' auto quantization without BN, ciou switch off')
    ...
    # multiplier = 10 # for non quant
    multiplier = 6 # for quant
