...
def main():
    ...
    ap.add_argument('-t', '--target',     type=str,  default='zcu102', choices=['zcu102','zcu104','u50','vck190', 'ultra96'], help='Target board type (zcu102,zcu104,u50,vck190,ultra96). Default is zcu102')
